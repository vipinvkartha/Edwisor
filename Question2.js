//Assignment number 2  . Submitted by Vipin V Kartha
var pokemonDetails = {
    "pokemon": [{
      "id": 1,
      "num": "001",
...
//function to get the details of the pokemon with the name of the pokemon as the input
  function getDetails(pokemonName)
  {
    console.log("The details of pokemon " + pokemonName + " is given below") 
    var weakness = ""
    var type = ""
    var flag = false
    for(var poke in pokemonDetails.pokemon)
    {
        if(pokemonDetails.pokemon[poke].name.toLowerCase() == pokemonName.toLowerCase())
        {
           console.log("Name : " + pokemonDetails.pokemon[poke].name)
           console.log("ID : " + pokemonDetails.pokemon[poke].id)
           console.log("Height : " + pokemonDetails.pokemon[poke].height)
           console.log("Weight : " + pokemonDetails.pokemon[poke].weight)
           console.log("Candy : " + pokemonDetails.pokemon[poke].candy)
           console.log("SpawnChance : " + pokemonDetails.pokemon[poke].spawn_chance)
           console.log("SpawnTime : " + pokemonDetails.pokemon[poke].spawn_time)
           console.log("AvgSpawns : " + pokemonDetails.pokemon[poke].avg_spawns)
           for(var pokeWeakness in pokemonDetails.pokemon[poke].weaknesses)
                weakness += pokemonDetails.pokemon[poke].weaknesses[pokeWeakness] + " "
           for(var pokeType in pokemonDetails.pokemon[poke].type)
                type += pokemonDetails.pokemon[poke].type[pokeType] + " "
  ...
  //function to find the name of the pokemon given the next evolution pokemon name as input
  function getNextEvolution(pokemonName)
  {
    var flag = false
    console.log("The names of pokemon with next evolution as " + pokemonName + " is") 
    for(var poke in pokemonDetails.pokemon)
    {
        for(var evolve in pokemonDetails.pokemon[poke].next_evolution)
        {
             if(pokemonDetails.pokemon[poke].next_evolution[evolve].name.toLowerCase() == pokemonName.toLowerCase())
             {   
                 console.log(pokemonDetails.pokemon[poke].name)
                 flag = true
             }
        }
    }
  ...
  //function to find the names of the pokemon with given weakness
  function pokemonWithWeakness(pokemonWeakness)
  {
    var flag = false
    console.log("The names of pokemon with weakness " + pokemonWeakness + " is")
    for(var poke in pokemonDetails.pokemon)
    {
        for(var weakness in pokemonDetails.pokemon[poke].weaknesses)
        {  
            if(pokemonDetails.pokemon[poke].weaknesses[weakness].toLowerCase() == pokemonWeakness.toLowerCase())
            {
               console.log(pokemonDetails.pokemon[poke].name)
               flag = true
               break
...
getDetails("pikachu")
console.log("\n")
getNextEvolution("raichu")
console.log("\n")
pokemonWithWeakness("BUG")